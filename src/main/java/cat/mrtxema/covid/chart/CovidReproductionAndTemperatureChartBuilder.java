...
public class CovidReproductionAndTemperatureChartBuilder {
    private final CovidDataSeries covidData;

    public CovidReproductionAndTemperatureChartBuilder(CovidDataSeries covidData) {
    ...
    public ChartBuilder builder() {
        ...
        return new ChartBuilder()
                ...
                .series("Rt EpiEstim", sliceData(reproductionData.getEpiestimRt(), startInstant)).color(XChartSeriesColors.GREEN).add()
                .series("Temperatura mitjana", sliceData(covidData.getNormalizedTemperatures(3), startInstant))
